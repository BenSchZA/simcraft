<script lang="ts">
	...
	export let data: { label: Writable<string> };
...
<div class="pool-node" class:selected class:dragging>
...
<style>
	...
	:global(.pool-node .react-flow__handle) {
		width: 8px;
		height: 8px;
	...
	:global(.pool-node .react-flow__handle:hover) {
